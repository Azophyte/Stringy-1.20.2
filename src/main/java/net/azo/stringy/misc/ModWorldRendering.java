...
public class ModWorldRendering {
    ...
    static Block[] cutOutBlocks = {ModBlocks.COTTON_SHRUB, ModBlocks.POTTED_COTTON, ModBlocks.COTTON_CROP, ModBlocks.PAMPAS_GRASS_CROP,
    ModBlocks.WHITE_PAMPAS_GRASS_PLUME};
